...
/**
 * This interface represents a command handler for client command.
 * @author m4kh1ry
 *
 */
public interface IClientCommandHandler 
{
	 ...
	 */
	public abstract boolean handleClientCommand(String providedCommandLine,PrintStream outputStream,IServerStatusInterface targetServerInterface);
	 ...
	 * @param outputStream Output to write to.
	 */
	public abstract void displayClientCommandHelpMessage(PrintStream outputStream);
}
