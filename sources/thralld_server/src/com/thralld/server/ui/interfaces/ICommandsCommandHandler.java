...
/**
 * This interface represents a command handler for commands command.
 * @author m4kh1ry
 *
 */
public interface ICommandsCommandHandler 
{
	/***
	 ...
	 */
	public abstract boolean handleCommandsCommand(String providedCommandLine,PrintStream outputStream,IServerStatusInterface targetServerInterface);
	 ...
	 * @param outputStream Output to write to.
	 */
	public abstract void displayCommandsCommandHelpMessage(PrintStream outputStream);
}
