...
/**
 * This interface represents a command handler for loglevel command.
 * @author m4kh1ry
 *
 */
public interface ILogLevelCommandHandler 
{
	/***
	 ...
	 */
	public abstract boolean handleLogLevelCommand(String providedCommandLine,PrintStream outputStream,IServerStatusInterface targetServerInterface);
	 ...
	 * @param outputStream Output to write to.
	 */
	public abstract void displayLogLevelCommandHelpMessage(PrintStream outputStream);
}
