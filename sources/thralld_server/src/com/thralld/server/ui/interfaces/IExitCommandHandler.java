...
/**
 * This interface represents a command handler for exit command.
 * @author m4kh1ry
 *
 */
public interface IExitCommandHandler 
{
	/***
	 ...
	 */
	public abstract boolean handleExitCommand(String providedCommandLine,PrintStream outputStream,IServerStatusInterface targetServerInterface);
	 ...
	 * @param outputStream Output to write to.
	 */
	public abstract void displayExitCommandHelpMessage(PrintStream outputStream);
